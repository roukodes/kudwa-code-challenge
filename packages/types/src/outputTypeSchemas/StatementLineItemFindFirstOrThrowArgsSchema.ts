...
export const StatementLineItemFindFirstOrThrowArgsSchema: z.ZodType<Prisma.StatementLineItemFindFirstOrThrowArgs> =
  z
    .object({
...
export default StatementLineItemFindFirstOrThrowArgsSchema;
