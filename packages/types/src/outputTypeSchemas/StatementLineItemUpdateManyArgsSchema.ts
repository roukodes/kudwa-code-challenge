...
export const StatementLineItemUpdateManyArgsSchema: z.ZodType<Prisma.StatementLineItemUpdateManyArgs> =
  z
    .object({
      data: z.union([
...
export default StatementLineItemUpdateManyArgsSchema;
