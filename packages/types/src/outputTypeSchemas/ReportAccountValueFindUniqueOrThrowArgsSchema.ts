...
export const ReportAccountValueFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.ReportAccountValueFindUniqueOrThrowArgs> =
  z
    .object({
...
export default ReportAccountValueFindUniqueOrThrowArgsSchema;
