...
export const StatementLineItemFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.StatementLineItemFindUniqueOrThrowArgs> =
  z
    .object({
...
export default StatementLineItemFindUniqueOrThrowArgsSchema;
