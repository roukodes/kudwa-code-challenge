...
export const ReportAccountFindFirstOrThrowArgsSchema: z.ZodType<Prisma.ReportAccountFindFirstOrThrowArgs> =
  z
    .object({
...
export default ReportAccountFindFirstOrThrowArgsSchema;
