...
export const ReportAccountUpdateArgsSchema: z.ZodType<Prisma.ReportAccountUpdateArgs> = z
  .object({
    select: ReportAccountSelectSchema.optional(),
    include: z.lazy(() => ReportAccountIncludeSchema).optional(),
    data: z.union([ReportAccountUpdateInputSchema, ReportAccountUncheckedUpdateInputSchema]),
    where: ReportAccountWhereUniqueInputSchema,
  })
  .strict();

export default ReportAccountUpdateArgsSchema;
