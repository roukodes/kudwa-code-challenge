...
export const StatementFindFirstOrThrowArgsSchema: z.ZodType<Prisma.StatementFindFirstOrThrowArgs> =
  z
    .object({
      ...
      distinct: z
        .union([StatementScalarFieldEnumSchema, StatementScalarFieldEnumSchema.array()])
        .optional(),
    })
    .strict();

export default StatementFindFirstOrThrowArgsSchema;
