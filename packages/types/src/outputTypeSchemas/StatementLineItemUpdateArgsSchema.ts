...
import { StatementLineItemUncheckedUpdateInputSchema } from '../inputTypeSchemas/StatementLineItemUncheckedUpdateInputSchema';
import { StatementLineItemUpdateInputSchema } from '../inputTypeSchemas/StatementLineItemUpdateInputSchema';
...
export const StatementLineItemUpdateArgsSchema: z.ZodType<Prisma.StatementLineItemUpdateArgs> = z
  .object({
    select: StatementLineItemSelectSchema.optional(),
    include: z.lazy(() => StatementLineItemIncludeSchema).optional(),
    data: z.union([
      StatementLineItemUpdateInputSchema,
      StatementLineItemUncheckedUpdateInputSchema,
    ]),
    where: StatementLineItemWhereUniqueInputSchema,
  })
  .strict();

export default StatementLineItemUpdateArgsSchema;
