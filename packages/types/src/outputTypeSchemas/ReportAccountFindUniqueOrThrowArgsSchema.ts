...
export const ReportAccountFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.ReportAccountFindUniqueOrThrowArgs> =
  z
    .object({
...
export default ReportAccountFindUniqueOrThrowArgsSchema;
