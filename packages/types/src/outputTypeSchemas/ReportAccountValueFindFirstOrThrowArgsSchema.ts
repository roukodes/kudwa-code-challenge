...
export const ReportAccountValueFindFirstOrThrowArgsSchema: z.ZodType<Prisma.ReportAccountValueFindFirstOrThrowArgs> =
  z
    .object({
...
export default ReportAccountValueFindFirstOrThrowArgsSchema;
