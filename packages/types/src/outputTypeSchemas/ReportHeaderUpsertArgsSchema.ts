...
export const ReportHeaderUpsertArgsSchema: z.ZodType<Prisma.ReportHeaderUpsertArgs> = z
  .object({
    ...
    create: z.union([ReportHeaderCreateInputSchema, ReportHeaderUncheckedCreateInputSchema]),
    update: z.union([ReportHeaderUpdateInputSchema, ReportHeaderUncheckedUpdateInputSchema]),
  })
  .strict();

export default ReportHeaderUpsertArgsSchema;
