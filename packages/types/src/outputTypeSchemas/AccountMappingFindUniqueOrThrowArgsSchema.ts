...
export const AccountMappingFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.AccountMappingFindUniqueOrThrowArgs> =
  z
    .object({
...
export default AccountMappingFindUniqueOrThrowArgsSchema;
