...
export const StatementCategoryFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.StatementCategoryFindUniqueOrThrowArgs> =
  z
    .object({
...
export default StatementCategoryFindUniqueOrThrowArgsSchema;
