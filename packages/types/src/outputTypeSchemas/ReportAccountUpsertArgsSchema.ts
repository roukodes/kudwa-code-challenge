...
import { ReportAccountUncheckedUpdateInputSchema } from '../inputTypeSchemas/ReportAccountUncheckedUpdateInputSchema';
import { ReportAccountUpdateInputSchema } from '../inputTypeSchemas/ReportAccountUpdateInputSchema';
...
export const ReportAccountUpsertArgsSchema: z.ZodType<Prisma.ReportAccountUpsertArgs> = z
  .object({
    ...
    create: z.union([ReportAccountCreateInputSchema, ReportAccountUncheckedCreateInputSchema]),
    update: z.union([ReportAccountUpdateInputSchema, ReportAccountUncheckedUpdateInputSchema]),
  })
  .strict();

export default ReportAccountUpsertArgsSchema;
