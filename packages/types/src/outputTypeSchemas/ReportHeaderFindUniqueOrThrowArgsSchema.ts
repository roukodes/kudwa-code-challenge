...
export const ReportHeaderFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.ReportHeaderFindUniqueOrThrowArgs> =
  z
    .object({
...
export default ReportHeaderFindUniqueOrThrowArgsSchema;
