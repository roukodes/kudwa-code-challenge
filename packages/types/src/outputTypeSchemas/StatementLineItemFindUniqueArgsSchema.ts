...
export const StatementLineItemFindUniqueArgsSchema: z.ZodType<Prisma.StatementLineItemFindUniqueArgs> =
  z
    .object({
...
export default StatementLineItemFindUniqueArgsSchema;
