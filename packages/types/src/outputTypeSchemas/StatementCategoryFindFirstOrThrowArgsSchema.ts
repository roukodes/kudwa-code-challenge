...
export const StatementCategoryFindFirstOrThrowArgsSchema: z.ZodType<Prisma.StatementCategoryFindFirstOrThrowArgs> =
  z
    .object({
...
export default StatementCategoryFindFirstOrThrowArgsSchema;
