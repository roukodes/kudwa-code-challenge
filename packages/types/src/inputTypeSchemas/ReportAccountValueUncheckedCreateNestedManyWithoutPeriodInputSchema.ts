...
export const ReportAccountValueUncheckedCreateNestedManyWithoutPeriodInputSchema: z.ZodType<Prisma.ReportAccountValueUncheckedCreateNestedManyWithoutPeriodInput> =
  z
    .object({
      create: z
        .union([
...
export default ReportAccountValueUncheckedCreateNestedManyWithoutPeriodInputSchema;
