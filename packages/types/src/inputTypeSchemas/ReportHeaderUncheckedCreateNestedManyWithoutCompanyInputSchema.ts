...
export const ReportHeaderUncheckedCreateNestedManyWithoutCompanyInputSchema: z.ZodType<Prisma.ReportHeaderUncheckedCreateNestedManyWithoutCompanyInput> =
  z
    .object({
      create: z
        .union([
...
export default ReportHeaderUncheckedCreateNestedManyWithoutCompanyInputSchema;
