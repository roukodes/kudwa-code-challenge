...
export const StatementLineItemUpdateManyWithoutCategoryNestedInputSchema: z.ZodType<Prisma.StatementLineItemUpdateManyWithoutCategoryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default StatementLineItemUpdateManyWithoutCategoryNestedInputSchema;
