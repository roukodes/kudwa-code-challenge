...
export const ReportAccountUncheckedUpdateManyInputSchema: z.ZodType<Prisma.ReportAccountUncheckedUpdateManyInput> =
  z
    .object({
...
export default ReportAccountUncheckedUpdateManyInputSchema;
