...
export const ReportHeaderUpdateManyWithoutCompanyNestedInputSchema: z.ZodType<Prisma.ReportHeaderUpdateManyWithoutCompanyNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default ReportHeaderUpdateManyWithoutCompanyNestedInputSchema;
