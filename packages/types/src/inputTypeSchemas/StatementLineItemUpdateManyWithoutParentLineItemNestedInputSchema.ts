...
export const StatementLineItemUpdateManyWithoutParentLineItemNestedInputSchema: z.ZodType<Prisma.StatementLineItemUpdateManyWithoutParentLineItemNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default StatementLineItemUpdateManyWithoutParentLineItemNestedInputSchema;
