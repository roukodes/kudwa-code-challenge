...
export const StatementCreateNestedManyWithoutCompanyInputSchema: z.ZodType<Prisma.StatementCreateNestedManyWithoutCompanyInput> =
  z
    .object({
      create: z
        .union([
...
export default StatementCreateNestedManyWithoutCompanyInputSchema;
