...
export const ReportAccountValueUpdateManyWithoutPeriodNestedInputSchema: z.ZodType<Prisma.ReportAccountValueUpdateManyWithoutPeriodNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default ReportAccountValueUpdateManyWithoutPeriodNestedInputSchema;
