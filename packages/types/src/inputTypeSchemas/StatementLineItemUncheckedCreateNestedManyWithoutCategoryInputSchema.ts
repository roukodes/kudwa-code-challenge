...
export const StatementLineItemUncheckedCreateNestedManyWithoutCategoryInputSchema: z.ZodType<Prisma.StatementLineItemUncheckedCreateNestedManyWithoutCategoryInput> =
  z
    .object({
      create: z
        .union([
...
export default StatementLineItemUncheckedCreateNestedManyWithoutCategoryInputSchema;
