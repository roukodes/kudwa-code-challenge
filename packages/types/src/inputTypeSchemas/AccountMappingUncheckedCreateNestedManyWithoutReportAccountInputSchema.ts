...
export const AccountMappingUncheckedCreateNestedManyWithoutReportAccountInputSchema: z.ZodType<Prisma.AccountMappingUncheckedCreateNestedManyWithoutReportAccountInput> =
  z
    .object({
      create: z
        .union([
...
export default AccountMappingUncheckedCreateNestedManyWithoutReportAccountInputSchema;
