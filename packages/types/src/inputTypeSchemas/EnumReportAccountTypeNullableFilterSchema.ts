...
export const EnumReportAccountTypeNullableFilterSchema: z.ZodType<Prisma.EnumReportAccountTypeNullableFilter> =
  z
    .object({
      equals: z
...
export default EnumReportAccountTypeNullableFilterSchema;
