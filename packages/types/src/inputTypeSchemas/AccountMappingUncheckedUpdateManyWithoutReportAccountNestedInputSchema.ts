...
export const AccountMappingUncheckedUpdateManyWithoutReportAccountNestedInputSchema: z.ZodType<Prisma.AccountMappingUncheckedUpdateManyWithoutReportAccountNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default AccountMappingUncheckedUpdateManyWithoutReportAccountNestedInputSchema;
