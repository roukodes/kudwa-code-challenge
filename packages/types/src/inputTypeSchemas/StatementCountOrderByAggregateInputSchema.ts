...
export const StatementCountOrderByAggregateInputSchema: z.ZodType<Prisma.StatementCountOrderByAggregateInput> =
  z
    .object({
...
export default StatementCountOrderByAggregateInputSchema;
