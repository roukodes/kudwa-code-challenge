...
export const ReportAccountUncheckedCreateNestedManyWithoutParentAccountInputSchema: z.ZodType<Prisma.ReportAccountUncheckedCreateNestedManyWithoutParentAccountInput> =
  z
    .object({
      create: z
        .union([
...
export default ReportAccountUncheckedCreateNestedManyWithoutParentAccountInputSchema;
