...
export const ReportAccountUncheckedUpdateWithoutReportInputSchema: z.ZodType<Prisma.ReportAccountUncheckedUpdateWithoutReportInput> =
  z
    .object({
...
export default ReportAccountUncheckedUpdateWithoutReportInputSchema;
