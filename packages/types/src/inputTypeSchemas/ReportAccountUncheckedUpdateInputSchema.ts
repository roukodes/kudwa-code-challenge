...
export const ReportAccountUncheckedUpdateInputSchema: z.ZodType<Prisma.ReportAccountUncheckedUpdateInput> =
  z
    .object({
...
export default ReportAccountUncheckedUpdateInputSchema;
