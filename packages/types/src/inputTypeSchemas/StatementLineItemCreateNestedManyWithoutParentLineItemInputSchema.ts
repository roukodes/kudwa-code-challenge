...
export const StatementLineItemCreateNestedManyWithoutParentLineItemInputSchema: z.ZodType<Prisma.StatementLineItemCreateNestedManyWithoutParentLineItemInput> =
  z
    .object({
      create: z
        .union([
...
export default StatementLineItemCreateNestedManyWithoutParentLineItemInputSchema;
