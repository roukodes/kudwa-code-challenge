...
export const ReportAccountUpdateInputSchema: z.ZodType<Prisma.ReportAccountUpdateInput> = z
  .object({
    accountName: z
    ...
    type: z
      ...
      .optional()
      .nullable(),
    report: z.lazy(() => ReportHeaderUpdateOneRequiredWithoutAccountsNestedInputSchema).optional(),
    parentAccount: z
...
export default ReportAccountUpdateInputSchema;
