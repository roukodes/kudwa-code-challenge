...
export const StatementUncheckedCreateWithoutCategoriesInputSchema: z.ZodType<Prisma.StatementUncheckedCreateWithoutCategoriesInput> =
  z
    .object({
...
export default StatementUncheckedCreateWithoutCategoriesInputSchema;
