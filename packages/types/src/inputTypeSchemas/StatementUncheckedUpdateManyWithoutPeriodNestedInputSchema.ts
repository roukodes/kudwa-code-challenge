...
export const StatementUncheckedUpdateManyWithoutPeriodNestedInputSchema: z.ZodType<Prisma.StatementUncheckedUpdateManyWithoutPeriodNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default StatementUncheckedUpdateManyWithoutPeriodNestedInputSchema;
