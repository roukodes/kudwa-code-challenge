...
export const StatementSumOrderByAggregateInputSchema: z.ZodType<Prisma.StatementSumOrderByAggregateInput> =
  z
    .object({
...
export default StatementSumOrderByAggregateInputSchema;
