...
export const ReportAccountValueUncheckedUpdateManyWithoutAccountNestedInputSchema: z.ZodType<Prisma.ReportAccountValueUncheckedUpdateManyWithoutAccountNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default ReportAccountValueUncheckedUpdateManyWithoutAccountNestedInputSchema;
