...
export const StatementUncheckedUpdateWithoutPeriodInputSchema: z.ZodType<Prisma.StatementUncheckedUpdateWithoutPeriodInput> =
  z
    .object({
...
export default StatementUncheckedUpdateWithoutPeriodInputSchema;
