...
export const ReportAccountUpdateManyWithoutParentAccountNestedInputSchema: z.ZodType<Prisma.ReportAccountUpdateManyWithoutParentAccountNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default ReportAccountUpdateManyWithoutParentAccountNestedInputSchema;
