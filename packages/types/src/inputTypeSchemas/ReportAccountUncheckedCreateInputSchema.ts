...
export const ReportAccountUncheckedCreateInputSchema: z.ZodType<Prisma.ReportAccountUncheckedCreateInput> =
  z
    .object({
...
export default ReportAccountUncheckedCreateInputSchema;
