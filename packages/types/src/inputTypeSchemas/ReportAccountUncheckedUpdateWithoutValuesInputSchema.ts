...
export const ReportAccountUncheckedUpdateWithoutValuesInputSchema: z.ZodType<Prisma.ReportAccountUncheckedUpdateWithoutValuesInput> =
  z
    .object({
...
export default ReportAccountUncheckedUpdateWithoutValuesInputSchema;
