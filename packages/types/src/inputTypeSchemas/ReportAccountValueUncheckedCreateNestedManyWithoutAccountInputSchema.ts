...
export const ReportAccountValueUncheckedCreateNestedManyWithoutAccountInputSchema: z.ZodType<Prisma.ReportAccountValueUncheckedCreateNestedManyWithoutAccountInput> =
  z
    .object({
      create: z
        .union([
...
export default ReportAccountValueUncheckedCreateNestedManyWithoutAccountInputSchema;
