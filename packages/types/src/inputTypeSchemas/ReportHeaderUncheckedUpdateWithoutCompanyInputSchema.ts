...
export const ReportHeaderUncheckedUpdateWithoutCompanyInputSchema: z.ZodType<Prisma.ReportHeaderUncheckedUpdateWithoutCompanyInput> =
  z
    .object({
...
export default ReportHeaderUncheckedUpdateWithoutCompanyInputSchema;
