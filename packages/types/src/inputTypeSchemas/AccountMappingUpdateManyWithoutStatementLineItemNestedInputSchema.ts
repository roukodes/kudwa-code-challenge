...
export const AccountMappingUpdateManyWithoutStatementLineItemNestedInputSchema: z.ZodType<Prisma.AccountMappingUpdateManyWithoutStatementLineItemNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default AccountMappingUpdateManyWithoutStatementLineItemNestedInputSchema;
