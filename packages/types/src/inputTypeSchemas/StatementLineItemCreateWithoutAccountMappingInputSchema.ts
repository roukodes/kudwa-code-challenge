...
export const StatementLineItemCreateWithoutAccountMappingInputSchema: z.ZodType<Prisma.StatementLineItemCreateWithoutAccountMappingInput> =
  z
    .object({
      name: z.string(),
...
export default StatementLineItemCreateWithoutAccountMappingInputSchema;
