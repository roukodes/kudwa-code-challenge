...
export const StatementCategoryUncheckedUpdateManyInputSchema: z.ZodType<Prisma.StatementCategoryUncheckedUpdateManyInput> =
  z
    .object({
...
export default StatementCategoryUncheckedUpdateManyInputSchema;
