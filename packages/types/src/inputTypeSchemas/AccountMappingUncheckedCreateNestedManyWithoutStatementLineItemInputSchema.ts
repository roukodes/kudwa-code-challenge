...
export const AccountMappingUncheckedCreateNestedManyWithoutStatementLineItemInputSchema: z.ZodType<Prisma.AccountMappingUncheckedCreateNestedManyWithoutStatementLineItemInput> =
  z
    .object({
      create: z
        .union([
...
export default AccountMappingUncheckedCreateNestedManyWithoutStatementLineItemInputSchema;
