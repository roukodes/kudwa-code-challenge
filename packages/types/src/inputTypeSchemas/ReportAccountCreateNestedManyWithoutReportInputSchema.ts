...
export const ReportAccountCreateNestedManyWithoutReportInputSchema: z.ZodType<Prisma.ReportAccountCreateNestedManyWithoutReportInput> =
  z
    .object({
      create: z
        .union([
...
export default ReportAccountCreateNestedManyWithoutReportInputSchema;
