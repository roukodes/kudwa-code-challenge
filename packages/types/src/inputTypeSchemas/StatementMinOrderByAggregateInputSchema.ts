...
export const StatementMinOrderByAggregateInputSchema: z.ZodType<Prisma.StatementMinOrderByAggregateInput> =
  z
    .object({
...
export default StatementMinOrderByAggregateInputSchema;
