...
export const ReportAccountUncheckedUpdateManyWithoutReportNestedInputSchema: z.ZodType<Prisma.ReportAccountUncheckedUpdateManyWithoutReportNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default ReportAccountUncheckedUpdateManyWithoutReportNestedInputSchema;
