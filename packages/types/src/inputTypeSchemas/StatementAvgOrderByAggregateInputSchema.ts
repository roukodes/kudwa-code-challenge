...
export const StatementAvgOrderByAggregateInputSchema: z.ZodType<Prisma.StatementAvgOrderByAggregateInput> =
  z
    .object({
...
export default StatementAvgOrderByAggregateInputSchema;
