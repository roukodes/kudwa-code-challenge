...
export const StatementCategoryUpdateManyWithoutStatementNestedInputSchema: z.ZodType<Prisma.StatementCategoryUpdateManyWithoutStatementNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default StatementCategoryUpdateManyWithoutStatementNestedInputSchema;
