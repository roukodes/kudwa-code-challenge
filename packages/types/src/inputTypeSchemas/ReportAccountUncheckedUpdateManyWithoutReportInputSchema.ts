...
export const ReportAccountUncheckedUpdateManyWithoutReportInputSchema: z.ZodType<Prisma.ReportAccountUncheckedUpdateManyWithoutReportInput> =
  z
    .object({
...
export default ReportAccountUncheckedUpdateManyWithoutReportInputSchema;
