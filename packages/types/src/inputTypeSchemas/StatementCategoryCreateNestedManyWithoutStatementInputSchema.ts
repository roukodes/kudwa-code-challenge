...
export const StatementCategoryCreateNestedManyWithoutStatementInputSchema: z.ZodType<Prisma.StatementCategoryCreateNestedManyWithoutStatementInput> =
  z
    .object({
      create: z
        .union([
...
export default StatementCategoryCreateNestedManyWithoutStatementInputSchema;
