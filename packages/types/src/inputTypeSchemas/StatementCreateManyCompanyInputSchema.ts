...
export const StatementCreateManyCompanyInputSchema: z.ZodType<Prisma.StatementCreateManyCompanyInput> =
  z
    .object({
...
export default StatementCreateManyCompanyInputSchema;
