...
export const StatementUpdateManyWithoutCompanyNestedInputSchema: z.ZodType<Prisma.StatementUpdateManyWithoutCompanyNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default StatementUpdateManyWithoutCompanyNestedInputSchema;
